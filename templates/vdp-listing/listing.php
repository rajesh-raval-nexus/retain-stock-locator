        ...
        <div class="gfam-product-card">
            <div class="gfam-product-image">
                <div class="owl-carousel gfam-carousel">
                    <div class="item">
                        <img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/tractor1.png" alt="Farm Trailer" />
                    </div>
                    <div class="item">
                        <img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/tractor2.png" alt="Farm Trailer" />
                    </div>
                    <div class="item">
                        <img src="<?php echo get_stylesheet_directory_uri()?>/assets/images/tractor3.png" alt="Farm Trailer" />
                    </div>
                </div>
            </div>
