<?php
// Available variables: $first_name, $last_name, $email, $phone, $trade_in, $comments
$logo_url = '';
...
<head>
    ...
    <title><?= esc_html__('Request a Call Back', 'retain-stock-locator') ?></title>
    <style>
        body {
            margin: 0;
            padding: 0;
                    ...
                    <tr>
                        <td bgcolor="#92191C" style="padding: 30px 20px; text-align:center;">
                            ...
                            <h1 style="color:#fff; font-size:24px; margin-bottom:10px;">
                                <?= esc_html__('Call Back Request', 'retain-stock-locator') ?>
                            </h1>
                            <p style="color:#FDBD3D; font-size:14px;">
                                <?= esc_html__('Request details below', 'retain-stock-locator') ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:40px 30px;">
                            <p style="color:#333333; font-size:16px; line-height:1.6; margin-bottom:30px;">
                                ...
                                <?= esc_html__('A new call back request has been received. Here are the details:', 'retain-stock-locator') ?>
                            </p>
                            ...
                            <table width="100%" bgcolor="#f9f9f9" cellpadding="15" cellspacing="0"
                                ...
                                <tr>
                                    <td colspan="2"
                                        style="border-bottom:2px solid #FDBD3D; padding-bottom:10px; font-size:18px; color:#92191C;">
                                        <?= esc_html__('Request Details', 'retain-stock-locator') ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-weight:bold; color:#92191C; width:150px; font-size:14px;">
                                ...
                                <tr>
                                    <td style="font-weight:bold; color:#92191C; font-size:14px;">
                                        <?= esc_html__('Trade In', 'retain-stock-locator') ?>
                                    </td>
                                    <td style="color:#333333; font-size:14px;"><?= esc_html($trade_in) ?></td>
                                </tr>
                                <tr>
                                    <td style="font-weight:bold; color:#92191C; font-size:14px;">
                                        <?= esc_html__('Comments', 'retain-stock-locator') ?>
                                    </td>
                                    <td style="color:#333333; font-size:14px; white-space:pre-line;">
