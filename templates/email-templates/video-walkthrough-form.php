<?php
// Available variables: $first_name, $last_name, $email, $phone, $post_code, $make
$logo_url = '';
...
<head>
    ...
    <title><?= esc_html__('Video Walkthrough Request', 'retain-stock-locator') ?></title>
    <style>
        body {
            margin: 0;
            padding: 0;
                    ...
                    <tr>
                        <td bgcolor="#92191C" style="padding: 30px 20px; text-align:center;">
                            ...
                            <h1 style="color:#fff; font-size:24px; margin-bottom:10px;">
                                <?= esc_html__('Video Walkthrough Request', 'retain-stock-locator') ?>
                            </h1>
                            <p style="color:#FDBD3D; font-size:14px;">
                                <?= esc_html__('Your request details are below', 'retain-stock-locator') ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:40px 30px;">
                            <p style="color:#333333; font-size:16px; line-height:1.6; margin-bottom:30px;">
                                <?= esc_html__('Hi', 'retain-stock-locator') ?> <?= esc_html($first_name) ?>,<br>
                                <?= esc_html__('Thank you for requesting a video walkthrough. Here are the details:', 'retain-stock-locator') ?>
                            </p>
