<?php
// Available variables: $first_name, $last_name, $email, $phone, $post_code
$logo_url = '';
...
<head>
    ...
    <title><?= esc_html__('Ask a Question Submission', 'retain-stock-locator') ?></title>
    <style>
        body {
            margin: 0;
            padding: 0;
                    ...
                    <tr>
                        <td bgcolor="#92191C" style="padding: 30px 20px; text-align:center;">
                            ...
                            <h1 style="color:#fff; font-size:24px; margin-bottom:10px;">
                                <?= esc_html__('Ask a Question Form', 'retain-stock-locator') ?>
                            </h1>
                    ...
                    <tr>
                        <td style="padding:40px 30px;">
                            <p style="color:#333333; font-size:16px; line-height:1.6; margin-bottom:30px;">
                                ...
                                <?= esc_html__('A new "Ask a Question" submission has been received. Details are as follows:', 'retain-stock-locator') ?>
                            </p>
                            ...
                            <table width="100%" bgcolor="#f9f9f9" cellpadding="15" cellspacing="0"
                                ...
                                <tr>
                                    <td colspan="2"
                                        ...
                                        <?= esc_html__('Submission Details', 'retain-stock-locator') ?>
                                    </td>
                                </tr>
                                <tr>
